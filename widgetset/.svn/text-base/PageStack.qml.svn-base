...
Item {
    ...
    function back()
    {
        if (Engine.getDepth() > 1) return Engine.pop()
    }
        ...
        Item {
            ...
            function pushEnter(replace, immediate) {
                ...
                if (root.visible && immediate) {
                    __setPageStatus(page, WidgetSet.PageActive);
                }
            }
            ...
            transitions: [
                ...
                Transition {
                    ...
                    SequentialAnimation {
                        ...
                        PropertyAnimation { properties: "scale,opacity"; easing.type: Easing.InOutExpo; duration: UI.pageFadingDuration }
